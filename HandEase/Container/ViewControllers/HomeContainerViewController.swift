...
class HomeContainerViewController : UIViewController {
    ...
    @objc func handlePanGesture(_ recognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            break
        case .changed:
            self.containerCenterX.constant = self.containerCenterX.constant + recognizer.translation(in: view).x
    ...
    private func configureMenu() {
        guard let menu = ViewControllers.menu as? MenuViewController else {
            return
        }
    ...
    private func setCurrentViewController(viewController: UIViewController) {
